import { GfxElement, GfxLayer, GfxPanel, ILayerProps, ImageElement, ImageLoader, ImageRenderer } from "..";
...
function render(gfxPanel: GfxPanel, imagesHash: {[key: string]: HTMLImageElement}) {
  ...
  /*newcode start*/resetMovement(element);/*newcode end*/
}

/*newcode start*/function resetMovement(element: GfxElement) {
  element.setX(0);
  element.setY(0);
